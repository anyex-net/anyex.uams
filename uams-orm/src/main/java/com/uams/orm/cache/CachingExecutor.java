...
/**
 * <p>File：EnhancedCachingExecutor.java </p>
 * <p>Title: EnhancedCachingExecutor </p>
 * <p>Description: EnhancedCachingExecutor </p>
 * <p>Copyright: Copyright (c) 2014 08/21/2015 10:48</p>
 * <p>Company: BloCain</p>
 *
 * @author playguy
 * @version 1.0
...
@Intercepts(value = {@Signature(args = {MappedStatement.class, Object.class, RowBounds.class, ResultHandler.class}, method = "query", type = Executor.class),
        ...
        @Signature(args = {boolean.class}, method = "commit", type = Executor.class), @Signature(args = {boolean.class}, method = "rollback", type = Executor.class),
        @Signature(args = {boolean.class}, method = "close", type = Executor.class)})
public class CachingExecutor implements Interceptor
{
