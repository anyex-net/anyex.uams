	...
	<div data-options="region:'north',border:false" style="height: 30px; overflow: hidden;background-color: #fff">
        <form id="searchSysParameterForm">
            <table style="text-overflow: ellipsis; white-space: nowrap; overflow: hidden; width: auto; float: left;">
                <tr>
                    <th>系统名称:</th>
                    <td><input name="systemName"  style="width:100px;" placeholder="请输入系统名称"/></td>
                    <th>参数名称:</th>
                    <td><input name="parameterName"  style="width:100px;" placeholder="请输入参数名称"/></td>
                    <th>参数大类:</th>
                    <td><input name="division"  style="width:100px;" placeholder="请输入参数大类"/></td>
                    <th>参数类型:</th>
                    <td><input name="type"  style="width:100px;" placeholder="请输入参数类型"/></td>
                    <td>
