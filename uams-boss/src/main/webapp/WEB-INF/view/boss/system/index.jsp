...
<div id="loading"
    ...
    <img src="${res}/style/images/ajax-loader.gif"
    ...
    <div data-options="region:'center'" style="overflow: hidden;">
        <div id="index_tabs" style="overflow: hidden;">
            <div title="首页" data-options="iconCls:'fi-home',border:false" style="overflow: hidden;">
               <br>
                <h2>&nbsp;&nbsp;欢迎使用UAMS资产投资管理平台!</h2>
            </div>
        </div>
    </div>
    <div data-options="region:'south',border:false"
         style="height: 30px;line-height:30px; overflow: hidden;text-align: center;background-color: #eee">Copyright © 2017 power by UAMS </div>
</div>
<div id="tabsMenu">
