...
<script type="text/javascript">
    ...
    $(function () {
        sysOrderDataGrid = $('#sysOrderDataGrid').datagrid({
            url: '${ctx}/api/sysOrder/data',
            striped: true,
            rownumbers: true,
            pagination: true,
            singleSelect: true,
...
//                    sortable: true
        ...
        $("#curreListSysOrderTd").html(dictDropDownOptionsList('currencyList','currency', 'currency','', 'required:true,',  'width:142px,'));
        $("#currencyListSysOrder").combobox({
            valueField:'code',
            textField:'name'
        });
    ...
    function searchSysOrderFun() {
        sysOrderDataGrid.datagrid('load', $.serializeObject($('#searchSysOrderForm')));
    }
    function cleanSysOrderFun() {
        $('#searchSysOrderForm input').val('');
        sysOrderDataGrid.datagrid('load', {});
    }
</script>

<div class="easyui-layout" data-options="fit:true,border:false">
    <div data-options="region:'north',border:false" style="height: 30px; overflow: hidden;background-color: #fff">
        <form id="searchSysOrderForm">
            <table style="text-overflow: ellipsis; white-space: nowrap; overflow: hidden; width: auto; float: left;">
                <tr>
                    ...
                    <th>币种:</th>
                    <td id="currencyListSysOrderTd"></td>
                    <td>
                        <a href="javascript:void(0);" class="easyui-linkbutton"
                           data-options="iconCls:'fi-magnifying-glass',plain:true" onclick="searchSysOrderFun();">查询</a>
                        <a href="javascript:void(0);" class="easyui-linkbutton"
                           data-options="iconCls:'fi-x-circle',plain:true" onclick="cleanSysOrderFun();">清空</a>
                    </td>
                </tr>
            </table>
        </form>
    ...
    <div data-options="region:'center',border:true">
        <table id="sysOrderDataGrid" data-options="fit:true,border:false"></table>
    </div>
</div>
