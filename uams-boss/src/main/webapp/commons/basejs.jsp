...
<script type="text/javascript" src="${res}/js/dictionary.js" charset="utf-8"></script>
<script type="text/javascript" src="${res}/plupload/2.1.2/js/plupload.js" charset="utf-8"></script>

<script type="text/javascript">
    var basePath = "${ctx}";
    window.PROJECT_CONTEXT = "${ctx}";
    window.UEDITOR_HOME_URL = "${res}/ueditor/";
    window.SWF_UPLOAD_URL = "/static/plupload/2.1.2/js/Moxie.swf";
    window.XAP_UPLOAD_URL = "/static/plupload/2.1.2/js/Moxie.xap";
