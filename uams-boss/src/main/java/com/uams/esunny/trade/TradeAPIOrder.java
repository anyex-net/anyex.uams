...
@Controller
@RequestMapping("trade/tradeAPIOrder")
public class TradeAPIOrder {
	...
	public  void TradeAPIOrder() {
		...
		EsunnyWPTradeAPINotify apiNotify = new TradeAPINotifyOrder();
...
//	 	order.setExchangeNo("HKEX");//交易所编码
...
//        System.out.println("OrderCancel:"+tradeApi.cancelOrder(orderCancelReq));
		...
		//委托状态查询onRspQryOrderProcess
   		...
   		orderProcessReq.setOrderNo("OA201802090000055608");//委托编码
...
// 		System.out.println("hisDeliveryReq:"+tradeApi.qryHisDelivery(hisDeliveryReq));
        ...
        //交易信息通知onRtnTradeMessage
//         TapAPITradeMessageReq tradeMessageQryReq = new TapAPITradeMessageReq();
//         tradeMessageQryReq.setAccountNo(userNo);
// 		System.out.println("交易信息通知：qryTradeMessage:"+tradeApi.qryTradeMessage(tradeMessageQryReq));
