...
public class TradeAPICapital {
	...
	public  void tradeApoCapital() {
		...
		EsunnyWPTradeAPINotify apiNotify = new TradeAPINotifyCapital();
...
//		System.out.println("qryFill:"+tradeApi.qryFill(fillReq));
		...
		hisMatchReq.setBeginDate("2018-1-31");
		hisMatchReq.setEndDate("2018-2-6");
