...
@Controller
@RequestMapping("tradeSysOrderApi/tradeSysOrder")
public class TradeSysOrderApi {
    ...
    public  void TradeSysOrderApiTest() {
        ...
        EsunnyWPTradeAPINotify apiNotify = new TradeSysOrderApiNotify();
