...
import com.uams.rpc.api.service.SysPositionChangeService;
import com.uams.rpc.api.service.SysPositionProfitService;
...
public class TradeSysOrderApiNotify extends EsunnyWPTradeAPINotify {


    @Autowired(required = false)
    private SysPositionChangeService sysPositionChangeService;

    @Autowired(required = false)
    private SysPositionProfitService sysPositionProfitService;
...
//
//        sysPositionService = SpringContext.getBean(SysPositionService.class);
//        SysPositionModel sysysPositionModel=new SysPositionModel();
//        sysysPositionModel.setAccountInitialMargin(BigDecimal.valueOf(info.getAccountInitialMargin()));
//        sysysPositionModel.setAccountMaintenanceMargin(BigDecimal.valueOf(info.getAccountMaintenanceMargin()));
//        sysysPositionModel.setAccountNo(info.getAccountNo());
//        sysysPositionModel.setCalculatePrice(BigDecimal.valueOf(info.getCalculatePrice()));
//        sysysPositionModel.setCallOrPutFlag("0");
//        sysysPositionModel.setCommodityCurrency(info.getCommodityCurrency());
//        sysysPositionModel.setCommodityCurrencyGroup(info.getCommodityCurrencyGroup());
//        sysysPositionModel.setCommodityNo(info.getCommodityNo());
//        sysysPositionModel.setCommodityType("0");
//        sysysPositionModel.setContractNo(info.getContractNo());
//        sysysPositionModel.setExchangeNo(info.getExchangeNo());
//        sysysPositionModel.setHedgeFlag(String.valueOf(info.getHedgeFlag()));
//        sysysPositionModel.setLMEPositionProfit(BigDecimal.valueOf(info.getLMEPositionProfit()));
//        sysysPositionModel.setMatchNo(info.getMatchNo());
//        sysysPositionModel.setMatchSide(String.valueOf(info.getMatchSide()));
//        sysysPositionModel.setOptionMarketValue(BigDecimal.valueOf(info.getOptionMarketValue()));
//        sysysPositionModel.setOrderNo(info.getOrderNo());
//        sysysPositionModel.setPositionNo(info.getPositionNo());
//        sysysPositionModel.setPositionPrice(BigDecimal.valueOf(info.getPositionPrice()));
//        sysysPositionModel.setPositionProfit(BigDecimal.valueOf(info.getPositionProfit()));
//
//        sysysPositionModel.setPositionQty(Long.valueOf(info.getPositionQty()));
//
//        sysysPositionModel.setPositionStreamId(info.getPositionStreamId());
//        sysysPositionModel.setServerFlag(String.valueOf(info.getServerFlag()));
//        sysysPositionModel.setStrikePrice(info.getStrikePrice());
//        sysysPositionModel.setUpperInitialMargin(BigDecimal.valueOf(info.getUpperInitialMargin()));
//        sysysPositionModel.setUpperMaintenanceMargin(BigDecimal.valueOf(info.getUpperMaintenanceMargin()));
//        sysysPositionModel.setUpperNo(info.getUpperNo());
//
//
//
//
...
//
//        //入库
//        sysPositionService.saveSysPosition(sysysPositionModel);
//
...
//        System.out.println("查询期货持仓:onRspQryPosition--------------------------------------结束");
    ...
    public void onRtnPosition(TapAPIPositionInfo info) {
        ...
        sysPositionChangeService = SpringContext.getBean(SysPositionChangeService.class);
        SysPositionChangeModel sysPositionChangeModel=new SysPositionChangeModel();
        sysPositionChangeModel.setAccountInitialMargin(BigDecimal.valueOf(info.getAccountInitialMargin()));
        sysPositionChangeModel.setAccountMaintenanceMargin(BigDecimal.valueOf(info.getAccountMaintenanceMargin()));
        sysPositionChangeModel.setAccountNo(info.getAccountNo());
        sysPositionChangeModel.setCalculatePrice(BigDecimal.valueOf(info.getCalculatePrice()));
        sysPositionChangeModel.setCallOrPutFlag(String.valueOf(info.getCallOrPutFlag()));
        sysPositionChangeModel.setCommodityCurrency(info.getCommodityCurrency());
        sysPositionChangeModel.setCommodityCurrencyGroup(info.getCommodityCurrencyGroup());
        sysPositionChangeModel.setCommodityNo(info.getCommodityNo());
        sysPositionChangeModel.setCommodityType(String.valueOf(info.getCommodityType()));
        sysPositionChangeModel.setContractNo(info.getContractNo());

        sysPositionChangeModel.setExchangeNo(info.getExchangeNo());
        sysPositionChangeModel.setHedgeFlag(String.valueOf(info.getHedgeFlag()));
        sysPositionChangeModel.setLMEPositionProfit(BigDecimal.valueOf(info.getLMEPositionProfit()));
        sysPositionChangeModel.setMatchNo(info.getMatchNo());
        sysPositionChangeModel.setMatchSide(String.valueOf(info.getMatchSide()));
        sysPositionChangeModel.setOptionMarketValue(BigDecimal.valueOf(info.getOptionMarketValue()));
        sysPositionChangeModel.setOrderNo(info.getOrderNo());
        sysPositionChangeModel.setPositionNo(info.getPositionNo());
        sysPositionChangeModel.setPositionPrice(BigDecimal.valueOf(info.getPositionPrice()));

        sysPositionChangeModel.setPositionQty(Long.valueOf(info.getPositionQty()));

        sysPositionChangeModel.setPositionProfit(BigDecimal.valueOf(info.getPositionProfit()));
        sysPositionChangeModel.setPositionStreamId(info.getPositionStreamId());
        sysPositionChangeModel.setServerFlag(String.valueOf(info.getServerFlag()));
        sysPositionChangeModel.setStrikePrice(info.getStrikePrice());
        sysPositionChangeModel.setUpperInitialMargin(BigDecimal.valueOf(info.getUpperInitialMargin()));
        sysPositionChangeModel.setUpperMaintenanceMargin(BigDecimal.valueOf(info.getUpperMaintenanceMargin()));
        sysPositionChangeModel.setUpperNo(info.getUpperNo());

        sysPositionChangeService.saveSysPositionChange(sysPositionChangeModel);
    ...
    public void onRtnPositionProfit(TapAPIPositionProfitNotice info) {
        ...
        //解析入库
        sysPositionProfitService = SpringContext.getBean(SysPositionProfitService.class);

        SysPositionProfitModel sysPositionProfitModel=new SysPositionProfitModel();

        sysPositionProfitModel.setCalculatePrice(BigDecimal.valueOf(info.getOrderInfo().getCalculatePrice()));
        sysPositionProfitModel.setLMEPositionProfit(BigDecimal.valueOf(info.getOrderInfo().getLMEPositionProfit()));
        sysPositionProfitModel.setOptionMarketValue(BigDecimal.valueOf(info.getOrderInfo().getOptionMarketValue()));
        sysPositionProfitModel.setPositionNo(info.getOrderInfo().getPositionNo());
        sysPositionProfitModel.setPositionProfit(BigDecimal.valueOf(info.getOrderInfo().getPositionProfit()));
        sysPositionProfitModel.setPositionStreamId(info.getOrderInfo().getPositionStreamId());
        sysPositionProfitService.saveSysPositionProfit(sysPositionProfitModel);
