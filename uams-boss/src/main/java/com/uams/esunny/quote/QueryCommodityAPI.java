...
@Controller
@RequestMapping("quoteapi/queryCommodity")
public class QueryCommodityAPI {

    @RequestMapping(value = "", method = RequestMethod.GET)
    public  void QueryCommodityAPI() {
        ...
        //行情回调
        EsunnyWPQuoteAPINotify queryCommodityAPINotify = new QueryCommodityAPINotify();
        //quoteApi
        EsunnyWPQuoteAPI quoteApi = EsunnyWPQuoteAPI.createEsunnyWPQuoteAPI(appInfo);
        quoteApi.setHostAddress("123.15.58.21", 7171);

        //注册行情回调
        quoteApi.setAPINotify(queryCommodityAPINotify);
