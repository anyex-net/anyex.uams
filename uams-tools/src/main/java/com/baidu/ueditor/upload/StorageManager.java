...
public class StorageManager
{
    ...
    private static State valid(File file)
    {
        ...
        if ((!parentPath.exists()) && (!parentPath.mkdirs())) { return new BaseState(false, AppInfo.FAILED_CREATE_FILE); }
        if (!parentPath.canWrite()) { return new BaseState(false, AppInfo.PERMISSION_DENIED); }
