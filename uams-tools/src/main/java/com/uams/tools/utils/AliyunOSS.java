...
public class AliyunOSS
{
    ...
    {
        Map policy = null;
        OSSClient ossClient = new OSSClient(UamsConst.ALIYUN_OSS_ENDPOINT, UamsConst.ALIYUN_ACCESS_KEY, UamsConst.ALIYUN_ACCESS_SECRET);
        try
        {
            ...
            respMap.put("accessid", UamsConst.ALIYUN_ACCESS_KEY);
    ...
    public static void upload(String path, String fileName)
    {
        ...
        {
            // 设置断点续传请求
            UploadFileRequest uploadFileRequest = new UploadFileRequest(UamsConst.BUCKET_TEMP_NAME, fileName);
            // 指定上传的本地文件
    ...
    public static boolean transferObject(String fileName)
    {
        ...
        try
        {
            if (ossClient.doesObjectExist(UamsConst.BUCKET_TEMP_NAME, fileName))
            {
                ossClient.copyObject(UamsConst.BUCKET_TEMP_NAME, fileName, UamsConst.BUCKET_BITMS_NAME, fileName);
                ossClient.deleteObject(UamsConst.BUCKET_TEMP_NAME, fileName);
            }
        }
