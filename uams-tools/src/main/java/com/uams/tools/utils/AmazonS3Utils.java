...
import com.uams.tools.amazon.*;
import com.uams.tools.consts.UamsConst;
import com.uams.tools.consts.CharsetConst;
...
public class AmazonS3Utils
{
    ...
    static
    {
        credsProvider = new DefaultCredentialProvider(UamsConst.AWS_ACCESS_KEY_ID, UamsConst.AWS_SECRET_ACCESS_KEY);
    ...
    public static Map<String, Object> getPostPolicy(String dir, String host)
    {
        ...
        try
        {
            ...
            policyConds.addConditionItem("bucket", UamsConst.BUCKET_TEMP_NAME);
            ...
            map.put("accessid", UamsConst.AWS_ACCESS_KEY_ID);
    ...
    public static void upload(String path, String fileName)
    {
        try
        {
            getAmazonS3().putObject(new PutObjectRequest(UamsConst.BUCKET_TEMP_NAME, fileName, new File(path)).withCannedAcl(CannedAccessControlList.PublicRead));
        }
        catch (Throwable e)
        {
    ...
    public static boolean moveObject(String fileName)
    {
        ...
        try
        {
            getAmazonS3().copyObject(UamsConst.BUCKET_TEMP_NAME, fileName, UamsConst.BUCKET_BITMS_NAME, fileName);
            getAmazonS3().deleteObject(UamsConst.BUCKET_TEMP_NAME, fileName);
        }
        catch (RuntimeException e)
        {
            flag = false;
    ...
    {
        return deleteObject(UamsConst.BUCKET_TEMP_NAME, fileName);
    }
    ...
    static void initAmazonS3()
    {
        ...
        AWSCredentials credentials = new BasicAWSCredentials(UamsConst.AWS_ACCESS_KEY_ID, UamsConst.AWS_SECRET_ACCESS_KEY);
