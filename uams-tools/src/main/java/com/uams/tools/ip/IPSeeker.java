...
{
    public static final Logger          logger           = LoggerFactory.getLogger(IPSeeker.class);
    
    private volatile static IPSeeker    singleton;
    ...
    public void init()
    {
        try
        {
            ipCache = Maps.newHashMap();
            loc = new IPLocation();
            buf = new byte[100];
            b4 = new byte[4];
            b3 = new byte[3];
            String file = IPSeeker.class.getResource("/qqwry.dat").toString().substring(5);
    ...
    public String getAddress(String ip)
    {
        ...
        StringBuilder address = new StringBuilder(country).append(UamsConst.SEPARATOR).append(area);
