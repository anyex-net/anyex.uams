...
import com.uams.generator.model.Table;
import com.uams.generator.provider.DbModelHelper;
import com.uams.generator.provider.DbTableProvider;
...
public class GeneratorFile
{
    ...
    // 相对于项目的地址
    String        path      = "uams-generator/src/main/resources/template/crud";
