...
/**
 * 平台委托变化记录表 实体对象
 * <p>File：SysOrderChangeEntity.java</p>
 * <p>Title: SysOrderChangeEntity</p>
 * <p>Description:SysOrderChangeEntity</p>
 * <p>Copyright: Copyright (c) May 26, 2015</p>
 * <p>Company: BloCain</p>
 * @author Playguy
 * @version 1.0
 */
@ApiModel(description = "平台委托变化记录表")
public class SysOrderChangeEntity extends GenericEntity {
	
	protected static final long serialVersionUID = 1L;
	
	/**外层错误码*/
	@ApiModelProperty(value = "外层错误码", required = true)
	protected String errorCode1;
	/**客户资金帐号*/
