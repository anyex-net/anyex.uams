...
/**
 * 平台委托处理状态表 实体对象
 * <p>File：SysOrderProcessEntity.java</p>
 * <p>Title: SysOrderProcessEntity</p>
 * <p>Description:SysOrderProcessEntity</p>
 * <p>Copyright: Copyright (c) May 26, 2015</p>
 * <p>Company: BloCain</p>
 * @author Playguy
 * @version 1.0
 */
@ApiModel(description = "平台委托处理状态表")
public class SysOrderProcessEntity extends GenericEntity {
	...
	/**有效日期(GTD情况下使用)*/
	@NotNull(message = "有效日期(GTD情况下使用)不可为空")
	@ApiModelProperty(value = "有效日期(GTD情况下使用)", required = true)
	...
	protected java.util.Date orderUpdateTime;
	/**委托更新人*/
	...
	public java.util.Date getOrderUpdateTime()
	{
		return this.orderUpdateTime;
	}
	
	public void setOrderUpdateTime(java.util.Date orderUpdateTime)
	{
