...
import com.uams.rpc.base.entity.OrgTradeChannelCfgEntity;
...
public class OrgTradeChannelCfgModel extends OrgTradeChannelCfgEntity
{
    /** 机构名称 */
    ...
    {
        final StringBuilder sb = new StringBuilder("OrgTradeChannelCfgModel{");
        ...
        sb.append(", tradeAcount='").append(tradeAcount).append('\'');
        sb.append(", fundAccout='").append(fundAccout).append('\'');
