...
/**
 * <p>File：SessionCacheManager.java </p>
 * <p>Title: 自定义授权缓存管理类 </p>
 * <p>Description: SessionCacheManager </p>
...
public class SessionCacheManager implements CacheManager
{
    ...
    public class SessionCache<K, V> implements Cache<K, V>
    {
        ...
        public V get(K key) throws CacheException
        {
            ...
            if (request != null)
            {
                V v = (V) request.getAttribute(cacheKeyName);
                if (v != null) { return v; }
            }
            V value = (V) getSession().getAttribute(cacheKeyName);
