...
import com.uams.security.interceptor.CSRFTokenManager;
...
public class RedisSessionManager
{
    ...
    */
    ...
    static String getRealKey(HttpServletRequest request, SessionKey key)
    {
        ...
        return new StringBuilder(key.getValue()).append(UamsConst.SEPARATOR).append(sessionId).toString();
    }
    ...
    */
    static String getRealKey(HttpServletRequest request, SessionKey sessionKey, String key)
    {
        String sessionId = getSessionId(request);
        if (StringUtils.isBlank(sessionId)) return null;
        StringBuilder realKey = new StringBuilder(sessionKey.getValue()).append(UamsConst.SEPARATOR);
        realKey.append(sessionId).append(UamsConst.SEPARATOR).append(key);
